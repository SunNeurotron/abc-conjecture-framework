...
\bibitem{joshi2025} Joshi, K. (2025). Update on IUT-related comparisons and anabelomorphy (May 2025). arXiv [math.NT].
...
\bibitem{scholze2022} Scholze, P., \& Stix, J. (2022). Why abc is still a conjecture. arXiv:2212.12345.
...
\bibitem{vojta} Vojta, P. (1987). \textit{Diophantine Approximations and Value Distribution Theory}. Lecture Notes in Mathematics, 1239. Springer-Verlag.
\bibitem{masser} Masser, D. W. (1985). Open problems. In \textit{Proceedings of the Symposium on Analytic Number Theory}.
\bibitem{oesterle} Oesterlé, J. (1988). Nouvelles approches du "théorème" de Fermat. \textit{Séminaire Bourbaki}, Vol. 1987/88.
\bibitem{wikiabc} Wikipedia contributors. (2025). "abc conjecture". \textit{Wikipedia, The Free Encyclopedia}.
\end{thebibliography}
